...
</iron-iconset-svg>`;document.head.appendChild($_documentContainer$1.content);Polymer$1({_template:html`
    <style>
      :host {
        display: inline-block;
      }
...
</dom-module>`;document.head.appendChild($_documentContainer$4.content);Polymer$1({is:"paper-button",behaviors:[PaperButtonBehavior],properties:{raised:{type:Boolean,reflectToAttribute:!0,value:!1,observer:"_calculateElevation"}},_calculateElevation:function(){if(!this.raised){this._setElevation(0)}else{PaperButtonBehaviorImpl._calculateElevation.apply(this)}}});const $_documentContainer$5=document.createElement("template");$_documentContainer$5.setAttribute("style","display: none;");$_documentContainer$5.innerHTML=`<custom-style>
  <style is="custom-style">
    html {
...
</dom-module>`;document.head.appendChild($_documentContainer$13.content);Polymer$1({_template:html`
...
`,is:"paper-item",behaviors:[PaperItemBehavior]});Polymer$1({_template:html`
    ...
    <slot></slot>
`,is:"paper-listbox",behaviors:[IronMenuBehavior],hostAttributes:{role:"listbox"}});class NLGColors extends PolymerElement{static get template(){return html`

`}static get is(){return"nlg-colors"}static get properties(){return{_colors:{type:Array,value:[{id:"Dark blue",value:"#1F28BF"},{id:"Nuxeo blue",value:"#0066FF"},{id:"Light blue",value:"#00ADED"},{id:"Teal",value:"#73D2CF"},{id:"Purple",value:"#8400FF"},{id:"Red",value:"#FF0044"},{id:"Orange",value:"#FF9E00"},{id:"Black",value:"#000000"},{id:"Medium gray",value:"#7F8284"},{id:"Light gray",value:"#BCBFBF"},{id:"White",value:"#FFFFFF"}]}}}get(id){return this._colors.find(color=>color.id===id)}getAll(){return this._colors}}window.customElements.define(NLGColors.is,NLGColors);class NLGColorPicker extends PolymerElement{static get template(){return html`
    <style>
      div.color-preview {
        width: 20px;
        height: 20px;
...
`}static get is(){return"nlg-color-picker"}static get properties(){return{fill:{type:String,notify:!0,observer:"_onFillChange"},label:String,opacity:{type:Number,notify:!0},_selected:{type:Number,observer:"_onSelectedChange"}}}_getColors(){return this.$.colors.getAll()}_onFillChange(){const colors=this._getColors(),defaultColor=colors.find(color=>color.value.toLowerCase()===this.fill.toLowerCase());this.$.colorList.selected=defaultColor?colors.indexOf(defaultColor):colors.length}_onSelectedChange(){const colors=this._getColors();if(this._selected===colors.length){return}this.fill=colors[this._selected].value}}window.customElements.define(NLGColorPicker.is,NLGColorPicker);class NLGSizePicker extends PolymerElement{static get template(){return html`
    <style>
      paper-input {
        width: 8em;
        text-align: center;
...
`}static get is(){return"nlg-size-picker"}static get properties(){return{height:{type:Number,notify:!0,observer:"_validateHeight"},width:{type:Number,notify:!0,observer:"_validateWidth"},_min:{type:Number,value:1},_max:{type:Number,value:8192}}}_isValidInput(value){return value>=this._min&&value<=this._max}_validateHeight(){this.$.height.invalid=!this._isValidInput(this.height)}_validateWidth(){this.$.width.invalid=!this._isValidInput(this.width)}}window.customElements.define(NLGSizePicker.is,NLGSizePicker);class NLGTemplates extends PolymerElement{static get template(){return html`

`}static get is(){return"nlg-templates"}static get properties(){return{_templates:{type:Array,value:[{id:"Avatar-01",viewBox:`0 0 225 225`,width:250,height:250,primaryFill:"#0066FF",primaryOpacity:1,backgroundFill:"#FFFFFF",backgroundOpacity:0,geometry:`
            ...
            `},{id:"Avatar-02",viewBox:`0 0 16 16`,width:250,height:250,primaryFill:"#FFFFFF",primaryOpacity:1,secondaryFill:"#1F28BF",secondaryOpacity:1,backgroundFill:"#FFFFFF",backgroundOpacity:0,geometry:`
              <defs>
                <mask id="mask">
            ...
            `},{id:"Avatar-03",viewBox:`0 0 16 16`,width:250,height:250,primaryFill:"#0066FF",primaryOpacity:1,secondaryFill:"#73D2CF",secondaryOpacity:1,backgroundFill:"#FFFFFF",backgroundOpacity:0,geometry:`
              <defs>
                <mask id="mask">
                  <rect fill="white" width="100%" height="100%"/>
            ...
            `},{id:"NUXEO-LOGO-1",viewBox:`0 0 362.98 68.06`,width:533,height:100,primaryFill:"#1F28BF",primaryOpacity:1,secondaryFill:"#0066FF",secondaryOpacity:1,backgroundFill:"#FFFFFF",backgroundOpacity:0,geometry:`
            ...
            `},{id:"NUXEO-LOGO-3",viewBox:`0 0 215.52 214.28`,width:250,height:250,primaryFill:"#1F28BF",primaryOpacity:1,secondaryFill:"#0066FF",secondaryOpacity:1,backgroundFill:"#FFFFFF",backgroundOpacity:0,geometry:`
            ...
            `},{id:"NUXEO-LOGO-3-BL",viewBox:`0 0 215.52 214.28`,width:250,height:250,primaryFill:"#1F28BF",primaryOpacity:1,secondaryFill:"#0066FF",secondaryOpacity:1,backgroundFill:"#FFFFFF",backgroundOpacity:0,geometry:`
              <polygon class="primary" points="0 146.22 0 160.04 20.2 180.25 0 200.45 0 214.28 13.82 214.28 34.03 194.07 54.23 214.28 68.06 214.28 68.06 200.45 47.85 180.25 68.06 160.04 68.06 146.22 54.23 146.22 34.03 166.42 13.82 146.22 0 146.22"/>
              <polygon class="secondary" points="51.05 73.26 51.05 125.02 17.02 125.02 17.02 73.26 0 73.26 0 124.31 17.02 141.32 68.06 141.32 68.06 73.26 51.05 73.26"/>
              <polygon class="secondary" points="51.05 0 0 0 0 68.06 17.02 68.06 17.02 16.31 51.05 16.31 51.05 68.06 68.06 68.06 68.06 17.02 51.05 0"/>
              <path class="secondary" d="M198.51,146.22h-51v51l17,17h51v-51Zm0,51.75h-34V162.52h34Z"/>
              <polygon class="secondary" points="141.79 162.52 141.79 146.22 73.73 146.22 73.73 214.28 141.79 214.28 141.79 197.97 90.75 197.97 90.75 188.16 141.08 188.16 141.08 171.97 90.75 171.97 90.75 162.52 141.79 162.52"/>
            `},{id:"NUXEO-LOGO-3-TR",viewBox:`0 0 215.52 214.28`,width:250,height:250,primaryFill:"#1F28BF",primaryOpacity:1,secondaryFill:"#0066FF",secondaryOpacity:1,backgroundFill:"#FFFFFF",backgroundOpacity:0,geometry:`
              <polygon class="primary" points="147.46 0 147.46 13.82 167.67 34.03 147.46 54.23 147.46 68.06 161.29 68.06 181.49 47.85 201.7 68.06 215.52 68.06 215.52 54.23 195.32 34.03 215.52 13.82 215.52 0 201.7 0 181.49 20.2 161.29 0 147.46 0"/>
              <polygon class="secondary" points="124.78 0 124.78 51.75 90.75 51.75 90.75 0 73.73 0 73.73 51.05 90.75 68.06 141.79 68.06 141.79 0 124.78 0"/>
              <polygon class="secondary" points="51.05 0 0 0 0 68.06 17.02 68.06 17.02 16.31 51.05 16.31 51.05 68.06 68.06 68.06 68.06 17.02 51.05 0"/>
              <path class="secondary" d="M198.51,146.22h-51v51l17,17h51v-51Zm0,51.75h-34V162.52h34Z"/>
              <polygon class="secondary" points="215.13 89.18 215.13 72.88 147.07 72.88 147.07 140.93 215.13 140.93 215.13 124.63 164.09 124.63 164.09 114.82 214.43 114.82 214.43 98.63 164.09 98.63 164.09 89.18 215.13 89.18"/>
            `},{id:"NUXEO-X",viewBox:`0 0 450 450`,width:250,height:250,primaryFill:"#0066FF",primaryOpacity:1,backgroundFill:"#FFFFFF",backgroundOpacity:0,geometry:`
            ...
            `}]}}}get(id){return this._templates.find(template=>template.id===id)}getAll(){return this._templates}getSkeleton(width,height,viewBox,primaryFill,primaryOpacity,secondaryFill,secondaryOpacity,backgroundFill,backgroundOpacity,geometry){return`
    ...
    `}}window.customElements.define(NLGTemplates.is,NLGTemplates);class SvgWrapper extends PolymerElement{static get is(){return"svg-wrapper"}static get template(){return html`<canvas id="canvas" style="display:none;"></canvas>`}static get properties(){return{svgData:{type:String,value:"",observer:"_dataChanged"},svgElement:{type:HTMLElement},preRender:{type:Boolean},finalSvgData:{type:String},reference:{type:String}}}ready(){super.ready();if(this.firstElementChild){this.svgData=this.firstElementChild.outerHTML}}dispatchRenderStart(){this.shouldFireRenderStart=!1;this.dispatchEvent(new CustomEvent("renderStart",{bubbles:!0,composed:!0}))}dispatchRenderCompleted(){this.shouldFireRenderComplete=!1;this.dispatchEvent(new CustomEvent("renderComplete",{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback();if(this.shouldFireRenderStart){this.dispatchRenderStart();this.shouldFireRenderStart=!1}if(this.shouldFireRenderComplete){this.dispatchRenderCompleted();this.shouldFireRenderComplete=!1}}drawOnCanvas(){if(this.reference){SvgWrapper.cachedData[this.reference]=SvgWrapper.cachedData[this.reference]||{};SvgWrapper.cachedDataObservers[this.reference]=SvgWrapper.cachedDataObservers[this.reference]||[]}var w=this.svgElement.clientWidth,h=this.svgElement.clientHeight;this.$.canvas.width=w*window.devicePixelRatio;this.$.canvas.height=h*window.devicePixelRatio;if(0==this.$.canvas.width||0==this.$.canvas.height){Polymer.RenderStatus.afterNextRender(this,this.drawOnCanvas);return}this.$.canvas.style.width=w+"px";this.$.canvas.style.height=h+"px";var DOMURL=window.URL||window.webkitURL||window,ctx=this.$.canvas.getContext("2d"),draw=function(){ctx.drawImage(this.img,0,0,this.$.canvas.width,this.$.canvas.height);DOMURL.revokeObjectURL(this.url);if(this.reference){SvgWrapper.cachedData[this.reference]={width:this.$.canvas.width,height:this.$.canvas.height,styleWidth:this.$.canvas.style.width,styleHeight:this.$.canvas.style.height,data:ctx.getImageData(0,0,this.$.canvas.width,this.$.canvas.height)};for(var callbacks=SvgWrapper.cachedDataObservers[this.reference],i=callbacks.length-1,callback;0<=i;i--){callback=callbacks[i];if("function"===typeof callback){callback()}callbacks.splice(i,1)}}this.svgElement.style.display="none";if(this.isConnected){this.dispatchRenderCompleted()}else{this.shouldFireRenderComplete=!0}}.bind(this);if(this.imageLoaded){draw()}else{this.img.onload=function(){draw()}.bind(this)}}drawFromCache(){if(this.reference){if(SvgWrapper.cachedData.hasOwnProperty(this.reference)){if(this.waitingCache){return!0}var copyData=function(){Polymer.RenderStatus.afterNextRender(this,function(){var data=SvgWrapper.cachedData[this.reference];this.$.canvas.style.display="";this.$.canvas.width=data.width;this.$.canvas.height=data.height;this.$.canvas.style.width=data.styleWidth;this.$.canvas.style.height=data.styleHeight;var ctx=this.$.canvas.getContext("2d");ctx.putImageData(data.data,0,0);this.waitingCache=!1;if(this.isConnected){this.dispatchRenderCompleted()}else{this.shouldFireRenderComplete=!0}})}.bind(this);this.waitingCache=!0;if(SvgWrapper.cachedData[this.reference].hasOwnProperty("data")){copyData()}else{SvgWrapper.cachedDataObservers[this.reference].push(copyData)}return!0}}return!1}_dataChanged(newData){var haveData=!!newData.trim(),fromCache=this.drawFromCache();if(haveData||fromCache){if(this.isConnected){this.dispatchRenderStart()}else{this.shouldFireRenderStart=!0}}if(fromCache){return}if(haveData){if(this.svgElement)this.shadowRoot.removeChild(this.svgElement);var finalSvgData=newData.replace(/svg-style>/gmi,"style>"),holder=document.createElement("div");holder.innerHTML=finalSvgData;this.svgElement=holder.firstElementChild;if(this.svgElement&&"svg"!=this.svgElement.nodeName.toLowerCase()){console.error("Is not an SVG");return}this.shadowRoot.appendChild(this.svgElement);this.svgElement.style.display="";if(this.preRender){this.svgElement.style.opacity="1";this.imageLoaded=!1;this.$.canvas.style.display="";var DOMURL=window.URL||window.webkitURL||window,blob=new Blob([finalSvgData],{type:"image/svg+xml"});this.url=DOMURL.createObjectURL(blob);this.img=new Image;this.img.onload=()=>{this.imageLoaded=!0};this.img.onerror=()=>{console.error("Cannot render SVG")};this.img.src=this.url;this.drawOnCanvas()}}else{this.$.canvas.style.display="none";if(this.svgElement){this.svgElement.style.display="none"}this.waitingCache=!1}}}SvgWrapper.cachedData={};SvgWrapper.cachedDataObservers={};customElements.define(SvgWrapper.is,SvgWrapper);class NLGApp extends PolymerElement{static get template(){return html`
    <style>
      :host {
        display: flex;
        flex-direction: column;
...
`}static get is(){return"nlg-app"}static get properties(){return{content:String,width:Number,height:Number,primaryFill:String,primaryOpacity:Number,secondaryFill:String,secondaryOpacity:Number,backgroundFill:String,backgroundOpacity:Number,template:Object,_showAlphaLayer:{type:Boolean,value:!0}}}static get observers(){return["_computeContent(template, width, height, primaryFill, primaryOpacity, secondaryFill, secondaryOpacity,"+"backgroundFill, backgroundOpacity)"]}ready(){window.devicePixelRatio=1;super.ready()}_getColors(){return this.$.colors.getAll()}_getTemplates(){return this.$.templates.getAll()}_computeContent(){if(!this.template){return this.content=""}const width=this.width?this.width:this.template.width,height=this.height?this.height:this.template.height,primaryFill=this.primaryFill?this.primaryFill:this.template.primaryFill,primaryOpacity=this.primaryOpacity?this.primaryOpacity:this.template.primaryOpacity,secondaryFill=this.secondaryFill?this.secondaryFill:this.template.secondaryFill,secondaryOpacity=this.secondaryOpacity?this.secondaryOpacity:this.template.secondaryOpacity,backgroundFill=this.backgroundFill?this.backgroundFill:this.template.backgroundFill,backgroundOpacity=this.backgroundOpacity?this.backgroundOpacity:this.template.backgroundOpacity;this.content=this.$.templates.getSkeleton(width,height,this.template.viewBox,primaryFill,primaryOpacity,secondaryFill,secondaryOpacity,backgroundFill,backgroundOpacity,this.template.geometry)}_itemSelected(e){this.template=this.$.templates.get(e.detail.item.id);this.width=this.template.width;this.height=this.template.height;this.primaryFill=this.template.primaryFill;this.primaryOpacity=this.template.primaryOpacity;this.secondaryFill=this.template.secondaryFill;this.secondaryOpacity=this.template.secondaryOpacity;this.backgroundFill=this.template.backgroundFill;this.backgroundOpacity=this.template.backgroundOpacity}_download(){const link=this.$.downloadLink;link.download=`${this.template.id}-${this.height}x${this.width}`;link.href=this.$.svgWrapper.shadowRoot.querySelector("canvas").toDataURL("image/png");link.click()}_getAlphaClass(){return this._showAlphaLayer?"show-alpha":""}}window.customElements.define(NLGApp.is,NLGApp)});